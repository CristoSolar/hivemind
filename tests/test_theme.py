...
from colmena.ui.theme import css, font_size
...
class ThemeTest(unittest.TestCase):
    ...
    def test_omarchy_font_square_corners_accent_borders(self):
        ...
        self.assertRegex(out, r"\.colmena-bubble-user \{[^}]*border: 2px solid #89b4fa")
        self.assertRegex(out, r"\.colmena-bubble-agent \{[^}]*border: 2px solid #585b70")
